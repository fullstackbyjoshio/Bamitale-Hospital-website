...
export function WhyChooseUs() {
  return (
    <>
      <SEO
        title="Why Choose Us | Bamitale Hospital Sagamu, Ogun State"
        description="Discover why patients trust Bamitale Hospital: 24/7 emergency care, experienced doctors, modern diagnostics, and affordable healthcare at 3 Folarin St, Makun, Sagamu."
      />
      <section id="why-choose-us" className="bg-gradient-dark py-20 lg:py-28 relative overflow-hidden">
        {/* Background Pattern */}
