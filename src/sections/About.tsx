...
export function About() {
  return (
    <>
      <SEO
        title="About Us | Bamitale Hospital Sagamu, Ogun State"
        description="Learn about Bamitale Hospital's mission to provide quality 24-hour healthcare to Sagamu and Ogun State. Located at 3 Folarin St, Makun. Emergency, maternity, laboratory & specialist care."
      />
