...
export function BookingForm() {
  ...
  if (submitted) {
    return (
      <>
        <SEO
          title="Appointment Confirmed | Bamitale Hospital Sagamu"
          description="Your appointment request has been received. Bamitale Hospital will contact you shortly to confirm your booking at 3 Folarin St, Makun, Sagamu."
        />
  ...
  return (
    <>
      <SEO
        title="Book Appointment | Bamitale Hospital Sagamu, Ogun State"
        description="Book an appointment online at Bamitale Hospital, Sagamu. Schedule consultations, check-ups, and specialist visits. Open 24 hours at 3 Folarin St, Makun. Call 0707 191 9154."
      />
      <section id="booking" className="bg-bamLight py-20 lg:py-28">
          ...
          <div className="grid lg:grid-cols-[1fr_340px] gap-8">
            ...
            >
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                />
                <div className="p-4">
                  <p className="text-xs text-bamGray">
                    Plus Code:{" "}
                    <span className="font-semibold text-bamDark">VJ2P+6V Sagamu</span>
                  </p>
                </div>
              </div>
            </motion.div>
