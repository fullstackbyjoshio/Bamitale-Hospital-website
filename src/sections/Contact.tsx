...
export function Contact() {
  return (
    <>
      <SEO
        title="Contact & Location | Bamitale Hospital Sagamu, Ogun State"
        description="Contact Bamitale Hospital in Sagamu, Ogun State. Address: 3 Folarin St, Makun. Phone: 0707 191 9154. WhatsApp: +2347071919154. Open 24 hours. Plus Code: VJ2P+6V Sagamu. Find us on Google Maps."
      />
